    ...
    if (isset($_GET['delete']) && isset($_GET['id'])) {
        ...
        if (mysqli_query($connection, $dlt_question_query)){
            if (mysqli_query($connection, $dlt_query)){
                header("Location: ../php/a_quiz_view.php");
                exit();
            } else {
    ...
    <div class="uni-wrapper">
        <div class="container flex-col">
            <div class="content-container">
                <div class="title-row">
                    <span><i class="bx bx-test-tube"></i>Practice Quizzes</span>
                        ...
                        <tbody id="quizTableBody">
                            ...
                            <?php 
                                ...
                                if ($_SESSION["role"] == "manager") {
                                    ...
                                    $query = "SELECT * FROM `quiz` WHERE `admin_id` = {$_SESSION['user_id']} AND `type` = 'prac'";
                                }
                ...
                <div class="pop-up-overlay" style="display: none">
                    <div class="pop-up">
                        ...
                        <div class="details">
                            <form id="addPracForm" method="post">
                                <div class="form-col">
                                    <div class="form-grp">
                                        <label for="title">Title</label>
                                        <input type="text" name="txtPracTitle" id="title" placeholder="Title"
                                            class="input-title" />
                                    </div>
                                    <div class="error">
