...
<head>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // const filterButtons = document.querySelectorAll('.sidebar-item button, .filter-item');
                ...
                <div class="main-content">
                    ...
                    <div class="filter">
                        <ul class="filter-list">
                            ...
                            <li data-type="Storyboard Reading">
                                <button class="filter-item" data-type="Storyboard Reading">Storyboard Reading</button>
                            </li>
                            <li data-type="Paragraph Reading">
                                <button class="filter-item" data-type="Paragraph Reading">Paragraph Reading</button>
                            </li>
                            <li data-type="Simple Flash card">
                                <button class="filter-item" data-type="Simple Flash Card">Simple Flash Card</button>
                            </li>
                            <li data-type="Advanced Flash card">
                                <button class="filter-item" data-type="Advanced Flash Card">Advanced Flash Card</button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="result-yes">
                        ...
                        if (mysqli_num_rows($results) > 0) {
                            while ($row = mysqli_fetch_assoc($results)) {
                                ...
                                ?>
                            <div class="result-card" data-id="<?php echo htmlspecialchars($row['mat_id']); ?>"
