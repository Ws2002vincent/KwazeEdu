...
if (isset($_POST["btnGetCode"])){
    ...
    if ($noError) {
        ...
        $email_message = file_get_contents('../html/email.html');
        // $email_message = 'Your code is: <b>' . $otp . '</b><br> This code will expire in 90 seconds.';
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="#" method="post">
                ...
                <!-- submit button -->
                <div class="submit">
                    <input type="submit" value="Sending OTP..." name="btnGetCode" disabled />
                </div>
            </form>
        </div>
    </div>
